<table>
    <thead>
        <tr>
            ...
            <th style="font-family: calibri; font-size: 16px; text-align: center; border: 1px solid black; background-color: yellow;">NIS</th>
            <th style="font-family: calibri; font-size: 16px; text-align: center; border: 1px solid black; background-color: yellow;">Nama Siswa</th>
            ...
            <th style="font-family: calibri; font-size: 16px; text-align: center; border: 1px solid black; background-color: yellow;">Status</th>
            <th style="font-family: calibri; font-size: 16px; text-align: center; border: 1px solid black; background-color: yellow;">Keterangan</th>
